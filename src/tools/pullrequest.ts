...
export function registerPullRequestTools(client: BitbucketClient) {
  return {
    list_pull_requests: {
    ...
    list_pull_request_activities: {
      ...
      handler: async (args: {
        ...
        const result = await client.getPullRequestActivities(
          args.projectKey,
          args.repoSlug,
          args.prId,
          args.limit
    ...
    needs_work_pull_request: {
      ...
      handler: async (args: {
        ...
        await client.setReviewerStatus(
          args.projectKey,
          args.repoSlug,
          args.prId,
          args.username,
          ...
          content: [
            {
              type: 'text' as const,
              text: JSON.stringify(
                { success: true, message: 'Pull request marked as needs work' },
                null,
                2
              ),
            },
    ...
    decline_pull_request: {
      ...
      handler: async (args: {
        ...
        const pr = await client.declinePullRequest(
          args.projectKey,
          args.repoSlug,
          args.prId,
          args.version
    ...
    add_pull_request_reviewers: {
      ...
      handler: async (args: {
        ...
        const pr = await client.addPullRequestReviewers(
          args.projectKey,
          args.repoSlug,
          args.prId,
          args.version,
    ...
    update_pull_request_comment: {
      ...
      handler: async (args: {
        ...
        const comment = await client.updatePullRequestComment(
          args.projectKey,
          args.repoSlug,
          args.prId,
          args.commentId,
    ...
    list_my_pull_requests: {
      ...
      handler: async (args: {
        ...
        const result = await client.getMyPullRequests(
          args.role || 'AUTHOR',
          args.state,
          args.limit
        );
